...
template <class T>
Vector3<T> vecProd (const Vector3<T>& v1, const Vector3<T>& v2){
...
template <class T>
inline Transformation3<T>::Transformation3 (const Vector3<T>& trans, const Quaternion<T>& rot){
	translationVector = trans;
	rotationQuaternion = rot;
}

template <class T>
inline Transformation3<T>::Transformation3 (const Transformation3<T>& t){
	translationVector = t.translationVector;
	rotationQuaternion = t.rotationQuaternion;
}

template <class T>
inline Transformation3<T>::Transformation3 (const Vector3<T>& trans){
	translationVector = trans;
	rotationQuaternion = Quaternion<T>(1.,0.,0.,0.);
}

template <class T>
inline Transformation3<T>::Transformation3 (const Quaternion<T>& rot){
	translationVector = Vector3<T>(0.,0.,0.);
	rotationQuaternion = rot;
}
