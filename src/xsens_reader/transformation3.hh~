...
struct Transformation3{
  ...
  Transformation3 (const Transformation3<T>& t);
  Transformation3 (const Vector3<T>& trans);
  Transformation3 (const Quaternion<T>& rot);
...
template <class T>
inline Vector3<T> vecProd (const Vector3<T>& v1, const Vector3<T>& v2);
